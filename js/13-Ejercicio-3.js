...
/*
Programa que muestra todos los números entre los dos números introducidos por el usuario
*/
var num1, num2;
...
if (num1 > num2) {
	...
	for (var i = +num2 + 1; i < num1; i++) {
		document.write("<p style='color: #31" + i + ";'>" + i + "</p>");
	}
}else{
	document.write("<h1>Numeros entre " + num1 + " y " + num2 + "</h1>");
	for (var i = +num1 + 1; i < num2; i++) {
		document.write("<p style='color: #13" + i + ";'>" + i + "</p>");
	}
}